package dev.ash.core.lib.dtos.example;

import dev.ash.core.lib.dtos.EnumMappable;

/**
 * Represents the various states an entity can be in within the system. This enum implements {@link EnumMappable} to allow for standardized conversion to {@link dev.ash.core.lib.dtos.EnumDTO} format.
 *
 ...
 * List&lt;{@link dev.ash.core.lib.dtos.EnumDTO}&gt; allStatuses = Arrays.stream(Status.values())
 *         .map({@link dev.ash.core.lib.dtos.EnumDTO}::fromEnum)
 *         .collect(Collectors.toList());
 * </pre>
 *
 * @see EnumMappable
 * @see dev.ash.core.lib.dtos.EnumDTO
 * @since 1.0
 */
