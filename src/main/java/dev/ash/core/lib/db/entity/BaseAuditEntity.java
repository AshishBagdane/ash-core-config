package dev.ash.core.lib.db.entity;

import dev.ash.core.lib.enums.HttpMethod;
import dev.ash.core.lib.enums.OperationType;
import dev.ash.core.lib.model.UserContext;
 ...
 * </ul>
 *
 * @see dev.ash.core.lib.model.UserContext
 * @see dev.ash.core.lib.enums.OperationType
 * @see dev.ash.core.lib.enums.HttpMethod
 */
@Entity
