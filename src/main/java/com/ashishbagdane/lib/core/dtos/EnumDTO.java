...
/**
 * A generic record for representing enum values in a standardized format. This record is particularly useful when
 * transferring enum data across service boundaries or when providing enum values through APIs.
 *
...
public record EnumDTO(Integer id, String value) {
    ...
    /**
     * Creates an EnumDTO from any enum that implements the com.ashishbagdane.lib.core.dtos.EnumMappable interface.
     *
